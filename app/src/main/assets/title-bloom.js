...
(function(global){
  ...
  const FS=`
    ...
    void main(){
      ...
      float a=0.;
      vec2 t=u_texel;
      a+=texture2D(u_title,v_uv+vec2(-4.*t.x,0.)).a*.05;
      a+=texture2D(u_title,v_uv+vec2(-2.5*t.x,0.)).a*.08;
      a+=texture2D(u_title,v_uv+vec2(-1.5*t.x,0.)).a*.12;
      a+=texture2D(u_title,v_uv+vec2(-.5*t.x,0.)).a*.16;
      ...
      a+=texture2D(u_title,v_uv+vec2(4.*t.x,0.)).a*.05;
      float b=0.;
      b+=texture2D(u_title,v_uv+vec2(0.,-4.*t.y)).a*.05;
      b+=texture2D(u_title,v_uv+vec2(0.,-2.5*t.y)).a*.08;
      b+=texture2D(u_title,v_uv+vec2(0.,-1.5*t.y)).a*.12;
      b+=texture2D(u_title,v_uv+vec2(0.,-.5*t.y)).a*.16;
      b+=a*.18;
      b+=texture2D(u_title,v_uv+vec2(0.,.5*t.y)).a*.16;
      b+=texture2D(u_title,v_uv+vec2(0.,1.5*t.y)).a*.12;
      b+=texture2D(u_title,v_uv+vec2(0.,2.5*t.y)).a*.08;
